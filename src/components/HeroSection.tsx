...
const HeroSection = () => {
  return (
    <section 
      className="relative min-h-screen flex flex-col items-center overflow-hidden pt-24 pb-24 md:pb-32"
      style={{ backgroundColor: "transparent" }}
    >
      {/* Wheel Section - Expanded to full width */}
      <div className="w-screen mb-4">
        <Suspense fallback={<div className="w-full h-[400px] animate-pulse bg-slate-900/20" />}>
          <WheelViewer scale={0.035} />
        </Suspense>
      </div>

      <div className="relative z-10 max-w-5xl mx-auto w-full flex flex-col items-center text-center px-6 -mt-28">
